...
class ForegroundImageView : ImageView {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        ...
        var foreground = a.getDrawable(R.styleable.ForegroundImageView_android_foreground)
        if (foreground == null) foreground = context.resources.getDrawable(R.drawable.transparent_overlay)
    ...
    fun setForegroundResource(drawableResId: Int) {
        setForegroundX(context.resources.getDrawable(drawableResId))
    }
